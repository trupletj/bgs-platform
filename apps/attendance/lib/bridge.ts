...
// postMessage({ type: "bgs-attendance:refresh-tokens", tokens }) илгээдэг.
...
const REFRESH_MESSAGE_TYPE = "bgs-attendance:refresh-tokens";
const HEIGHT_MESSAGE_TYPE = "bgs-attendance:height";
