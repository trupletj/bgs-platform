...
## Deploy (хийгдээгүй)
- Vercel дээр deploy хийхдээ **`NEXT_PUBLIC_PARENT_ORIGINS`** env-д заавал `https://m.bgs.mn` (mobile shell)-ийг оруулна, эс бөгөөс iframe "refused to connect". Утга: `https://m.bgs.mn,https://bgs.mn,https://bgs-mobile-app.vercel.app,http://localhost:3000,http://localhost:8080,http://localhost:8081`. (Топологи + gotcha: shared-context memory `bgs-vercel-deploy`.)
- Mobile-д embed хийх (attendance.web.tsx загвараар) + service нэмэх ажил хараахан хийгдээгүй.
